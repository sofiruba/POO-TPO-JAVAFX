...
public class GestorArchivoCursos {
    ...
    public void guardarCursos(List<Curso> cursos) {
        // Usamos try-with-resources para manejar el BufferedWriter
        try (BufferedWriter bw = new BufferedWriter(new FileWriter(ARCHIVO_CURSOS))) {

            for (Curso curso : cursos) {
                // Formato: idCurso,nombre,descripcion,precio,modalidad,datos_extra
                ...
                // Manejo del Polimorfismo para guardar datos específicos
